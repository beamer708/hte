...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    description: "A detailed walkthrough of building a complete brand identity from concept to final assets. Covers strategy, typography, color, and logo design — applicable to ERLC community branding projects.",
    type: "video",
  ...
  },
  {
    ...
    description: "Strategic guide on crafting memorable brands through consistent visual identity, tone, and positioning. Directly applicable to building a recognizable ERLC server identity.",
    type: "video",
