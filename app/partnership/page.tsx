...
export default function PartnershipPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setSuccess(
        "Your partnership application has been submitted. The @howtoerlc team will review it shortly."
      );
      setServerName("");
      setInviteLink("");
      setServerType("");
    ...
    <div className="py-12 sm:py-16">
      <div className="page-container max-w-3xl">
        ...
        <div className="mb-10 rounded-3xl border border-border/70 bg-card/75 p-6 sm:p-8">
          ...
          <h1 className="section-heading">Partner With @howtoerlc</h1>
          <p className="mt-3 text-base text-muted-foreground sm:text-lg">
            Apply to be featured on @howtoerlc as a trusted resource or community for the ERLC
            community. All applications are reviewed by the @howtoerlc team.
          </p>
        </div>
